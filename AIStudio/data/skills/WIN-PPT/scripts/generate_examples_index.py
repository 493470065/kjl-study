#!/usr/bin/env python3
"""
win-ppt - Examples Index Generator
...
def generate_examples_index(examples_dir: str = 'examples') -> str:
    ...
    content = []
    content.append("# win-ppt Example Projects Index\n")
    content.append("> This file is auto-generated by `skills/win-ppt/scripts/generate_examples_index.py`\n")
    ...
    content.append("---\n")
    content.append(
        f"*Auto-generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} by win-ppt*")
...
def main() -> None:
    ...
    print("=" * 80)
    print("win-ppt - Examples Index Generator")
    print("=" * 80 + "\n")
