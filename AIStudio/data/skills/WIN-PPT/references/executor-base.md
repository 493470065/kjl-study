...
```bash
ls skills/win-ppt/templates/icons/chunk-filled/ | grep home
ls skills/win-ppt/templates/icons/tabler-filled/ | grep home
ls skills/win-ppt/templates/icons/tabler-outline/ | grep chart
ls skills/win-ppt/templates/icons/phosphor-duotone/ | grep house
ls skills/win-ppt/templates/icons/simple-icons/ | grep github
```
