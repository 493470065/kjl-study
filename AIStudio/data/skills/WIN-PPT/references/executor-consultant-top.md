...
```
┌──────────────────────────────────�?�?Gradient top bar (0,0 �?1280,6)  �?├──────────────────────────────────�?�?Assertion title (x=40, y=50, 24px)�?├──────────────────────────────────�?�?Takeaway Box (x=40, y=75,        �? �?Dark background + white text, one-sentence conclusion
�?  w=1200, h=45)                  �?├──────────────────────────────────�?�?Content area (x=40, y=140,       �? �?Charts / data / analysis
�?  w=1200, h=520)                 �?├──────────────────────────────────�?�?Source | CONFIDENTIAL | Page #    �? �?y=700, 10px
└──────────────────────────────────�?```
