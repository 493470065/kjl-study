...
> Standalone post-generation step. Run after a deck containing data charts has finished SVG generation, before post-processing & export. Catches the 10�?0 px coordinate errors AI models routinely introduce when mapping data to pixel positions.
...
5. Run the matching calculator command:
   ...
   python3 skills/win-ppt/scripts/svg_position_calculator.py calc bar \
   ...
   python3 skills/win-ppt/scripts/svg_position_calculator.py calc line \
     --data "x1:y1,x2:y2,..." --area "x_min,y_min,x_max,y_max" --y-range "0,max"

   # pie_chart
   python3 skills/win-ppt/scripts/svg_position_calculator.py calc pie \
   ...
   python3 skills/win-ppt/scripts/svg_position_calculator.py calc radar \
...
```bash
python3 skills/win-ppt/scripts/svg_quality_checker.py <project_path>
```
...
```bash
python3 skills/win-ppt/scripts/total_md_split.py <project_path>
python3 skills/win-ppt/scripts/finalize_svg.py <project_path>
python3 skills/win-ppt/scripts/svg_to_pptx.py <project_path> -s final
```
