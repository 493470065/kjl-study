...
- Per-element animation applies to top-level SVG `<g id="...">` groups in z-order, with one presenter click revealing one semantic group; aim for 3â€? groups per slide
